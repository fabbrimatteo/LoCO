...
class JTATestSet(Dataset):
    ...
    * frame_path: path of `frame`
    ...
    def __init__(self, cnf=None):
        ...
        """
        self.cnf = cnf
        self.len = cnf.test_set_len
        self.test_data_path = cnf.jta_path / 'poses' / 'test'
        self.sequences = self.test_data_path.dirs()
    ...
    def __getitem__(self, i):
        ...
        data_path = self.test_data_path / f'seq_{sequence}/{frame}.data'
...
def main():
    ds = JTATestSet(cnf=Conf(exp_name='../conf/cp_100_jta.yaml', conf_file_path='../conf/cp_100_jta.yaml'))
